                                ...
                                <div className="col-lg-7 col-md-7">
                                    <div className="m-about-containt text-black p-t80">
                                        <div className="m-about-years bg-moving" style={{backgroundImage:"url(" + bnr1 + ")",width:"100%"}}>
                                            ...
                                            <h3 className="font-weight-900" style={{textAlign:'center'}}> <span style={{color:'#026EB6'}}> Sustainable Employment</span> <br/> That Enables Them To Thrive</h3>
                                        </div>
...
Welcome to FASTEST SERVICE GENERAL CONTRACTING EST, our company strives to develop and maintain an environment that encourages our energetic and diverse workforce to create value of our clients.

                                        </p>
                                        <p  style={{textAlign:"justify",textJustify:'inter-word'}}>We have various sectors like, Manpower, Heavy Equipment Rental, Material Supply, Trading, Civil works. Whatever your requirement is, our team can turn the burden of managing project and work force into a long term business for your organization.
                                        </p>
